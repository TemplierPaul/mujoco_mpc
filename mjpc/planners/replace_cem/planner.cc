...
void ReplaceCEMPlanner::Initialize(mjModel* model, const Task& task) {
...
// allocate memory
void ReplaceCEMPlanner::Allocate() {
  // initial state
...
void ReplaceCEMPlanner::Reset(int horizon,
...
// set state
void ReplaceCEMPlanner::SetState(const State& state) {
...
void ReplaceCEMPlanner::ActionFromPolicy(double* action, const double* state,
...
const Trajectory* ReplaceCEMPlanner::BestTrajectory() {
  return &nominal_trajectory;
}

// visualize planner-specific traces
void ReplaceCEMPlanner::Traces(mjvScene* scn) {
  // sample color
  float color[4];
  color[0] = 1.0;
  color[1] = 1.0;
...
void ReplaceCEMPlanner::GUI(mjUI& ui) {
...
void ReplaceCEMPlanner::Plots(mjvFigure* fig_planner, mjvFigure* fig_timer,
