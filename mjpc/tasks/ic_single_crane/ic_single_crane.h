#ifndef MJPC_TASKS_IC_SINGLE_CRANE_IC_SINGLE_CRANE_H_
#define MJPC_TASKS_IC_SINGLE_CRANE_IC_SINGLE_CRANE_H_
...
namespace mjpc {
  ...
  inline mjtNum ic_payloadSwayAngle(double *tip_pos, double *payload_pos) {
    mjtNum d[3];
...
class IC_Single_Crane : public Task {
 public:
  ...
  class ResidualFn : public BaseResidualFn {
   public:
    explicit ResidualFn(const IC_Single_Crane* task) : BaseResidualFn(task) {
    }
  ...
  IC_Single_Crane() : residual_(this) {}
...
#endif  // MJPC_TASKS_IC_SINGLE_CRANE_IC_SINGLE_CRANE_H_