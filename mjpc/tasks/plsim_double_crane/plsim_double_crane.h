#ifndef MJPC_TASKS_PLSIM_DOUBLE_CRANE_PLSIM_DOUBLE_CRANE_H_
#define MJPC_TASKS_PLSIM_DOUBLE_CRANE_PLSIM_DOUBLE_CRANE_H_
...
namespace mjpc {
  ...
  inline mjtNum plsim_double_payloadSwayAngle(double *tip_pos, double *payload_pos) {
    mjtNum d[3];
...
class PLSim_Double_Crane : public Task {
 public:
  ...
  class ResidualFn : public BaseResidualFn {
   public:
    explicit ResidualFn(const PLSim_Double_Crane* task) : BaseResidualFn(task) {
    }
  ...
  PLSim_Double_Crane() : residual_(this) {}
...
#endif  // MJPC_TASKS_PLSIM_DOUBLE_CRANE_PLSIM_DOUBLE_CRANE_H_