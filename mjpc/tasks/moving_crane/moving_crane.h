#ifndef MJPC_TASKS_MOVING_CRANE_MOVING_CRANE_H_
#define MJPC_TASKS_MOVING_CRANE_MOVING_CRANE_H_
...
namespace mjpc {
  ...
  inline mjtNum mc_payloadSwayAngle(double *tip_pos, double *payload_pos) {
    mjtNum d[3];
...
class Moving_Crane : public Task {
 public:
  ...
  class ResidualFn : public BaseResidualFn {
   public:
    explicit ResidualFn(const Moving_Crane* task) : BaseResidualFn(task) {
    }
...
#endif  // MJPC_TASKS_MOVING_CRANE_MOVING_CRANE_H_